import type { ErrorCode, ApiErrorResponse } from '../../../shared/types.js';
...
export const Errors = {
  ...
  aiService: (details?: string) =>
    new ApiError('AI_SERVICE_ERROR', 'AI analysis service unavailable', 503, details),

  rateLimit: () =>
    new ApiError('RATE_LIMIT_ERROR', 'Too many requests, please try again later', 429),
